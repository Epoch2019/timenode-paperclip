        ...
        <div className="flex items-center gap-2 min-w-0 flex-wrap">
          ...
          {issue.workMode === "planning" ? (
            <span
              ...
              title={conferenceRoomChatEnabled
                ? t("pages.issueDetail.planModeTitle", { defaultValue: "This task is in plan mode." })
                : t("pages.issueDetail.planningModeTitle", { defaultValue: "This task is in planning mode." })}
            >
              {conferenceRoomChatEnabled
                ? t("pages.issueDetail.planModeBadge", { defaultValue: "Plan mode" })
                : t("pages.issueDetail.planningBadge", { defaultValue: "Planning" })}
            </span>
          ) : null}
