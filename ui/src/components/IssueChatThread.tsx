            ...
            <Popover open={workModeMenuOpen} onOpenChange={setWorkModeMenuOpen}>
              <PopoverTrigger asChild>
                ...
                <button
                  ...
                  title={
                    isPlanning
                      ? t("components.issueChatThread.workModeTogglePlanTitle", { defaultValue: "Plan mode is on for this submission. Click to change." })
                      : t("components.issueChatThread.workModeToggleAgentTitle", { defaultValue: "Agent mode for this submission. Click to switch to plan mode." })
                  }
                  className={cn(
                ...
                >
                  ...
                  <span>{isPlanning
                    ? t("components.issueChatThread.planMode", { defaultValue: "Plan mode" })
                    : t("components.issueChatThread.agentMode", { defaultValue: "Agent mode" })}</span>
              ...
              >
                ...
                >
                  ...
                  <span>{isPlanning
                    ? t("components.issueChatThread.switchToAgentMode", { defaultValue: "Switch to agent mode" })
                    : t("components.issueChatThread.switchToPlanMode", { defaultValue: "Switch to plan mode" })}</span>
                </button>
              </PopoverContent>
            </Popover>
          ) : null}
