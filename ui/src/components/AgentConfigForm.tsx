    ...
    <div className={cn("relative", cards && "space-y-6")}>
      ...
      {forcedKubernetes ? (
        ...
        <div className={cn(!cards && (isCreate ? "border-t border-border" : "border-b border-border"))}>
          {cards
            ? <h3 className="text-sm font-medium mb-3">{t("components.agentConfigForm.sectionExecution", { defaultValue: "Execution" })}</h3>
            : <div className="px-4 py-2 text-xs font-medium text-muted-foreground">{t("components.agentConfigForm.sectionExecution", { defaultValue: "Execution" })}</div>
          }
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            <Field
        ...
        <div className={cn(!cards && (isCreate ? "border-t border-border" : "border-b border-border"))}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            <Field
              label={t("components.agentConfigForm.defaultEnvironmentLabel", { defaultValue: "Default environment" })}
              hint={t("components.agentConfigForm.defaultEnvironmentHint", { defaultValue: "Agent-level default execution target. Project and task settings can still override this." })}
            >
              <select
                className={inputClass}
              ...
              >
                <option value="">{t("components.agentConfigForm.companyDefaultLocal", { defaultValue: "Company default (Local)" })}</option>
      ...
      <div className={cn(!cards && (isCreate ? "border-t border-border" : "border-b border-border"))}>
        <div className={cn(cards ? "flex items-center justify-between mb-3" : "px-4 py-2 flex items-center justify-between gap-2")}>
          ...
          {showInlineAdapterTestEnvironmentButton && (
            ...
            >
              {testEnvironment.isPending
                ? t("components.agentConfigForm.testing", { defaultValue: "Testing..." })
                : t("components.agentConfigForm.test", { defaultValue: "Test" })}
            </Button>
          )}
        </div>
        <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
